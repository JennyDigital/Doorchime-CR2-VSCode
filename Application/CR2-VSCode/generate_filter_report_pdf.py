...
# ============================================================================
# PAGE 2: 16-bit and 8-bit LPF Comparison
# ============================================================================
fig = plt.figure(figsize=(8.27, 11.69))  # A4
gs = GridSpec(3, 1, figure=fig, hspace=0.5, top=0.93, bottom=0.08, left=0.12, right=0.88)

fig.suptitle('Low-Pass Filter Frequency Response', fontsize=14, fontweight='bold', y=0.96)
...
Note: Aggressive setting on 16-bit filter uses startup warm-up (8 passes) to eliminate transient cracking."""
...
2. 16-BIT BIQUAD LOW-PASS FILTER
   ...
   Feature: Automatic warm-up with 8 passes of first sample
